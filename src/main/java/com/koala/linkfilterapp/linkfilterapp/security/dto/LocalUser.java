...
public class LocalUser extends User implements OAuth2User, OidcUser {
    ...
    com.koala.linkfilterapp.linkfilterapp.security.entity.User user;
    ...
    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final com.koala.linkfilterapp.linkfilterapp.security.entity.User user) {
        this(userID, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities, user, null, null);
    }

    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final com.koala.linkfilterapp.linkfilterapp.security.entity.User user, OidcIdToken idToken,
    ...
    public static LocalUser create(com.koala.linkfilterapp.linkfilterapp.security.entity.User user, Map<String, Object> attributes, OidcIdToken idToken, OidcUserInfo userInfo) {
    ...
    public com.koala.linkfilterapp.linkfilterapp.security.entity.User getUser() {
        return user;
    }
}
